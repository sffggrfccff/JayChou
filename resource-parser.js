...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇸🇬": ["SG", "Singapore","SINGAPORE", "新", "新加坡", "狮城", "獅城", "沪新", "京新", "泉新", "穗新", "深新", "杭新", "广新","廣新","滬新"],
    "🇺🇸": ["US", "USA", "America", "United States", "美国", "美", "京美", "波特兰", "达拉斯", "俄勒冈", "凤凰城", "费利蒙", "硅谷", "矽谷", "拉斯维加斯", "洛杉矶", "圣何塞", "圣荷西", "圣克拉拉", "西雅图", "芝加哥", "沪美", "哥伦布", "纽约", "旧金山", "亚特兰大"],
    ...
    "🇯🇵": ["JP", "Japan","JAPAN", "日", "日本", "东京", "大阪", "埼玉", "京日", "苏日", "沪日","上日", "穗日", "川日", "中日", "泉日", "杭日", "深日", "辽日", "广日", "Tokyo"],
    "🇦🇷": ["AR ", "Argentina", "阿根廷","AR-"],
    "🇳🇴": ["Norway", "挪威", "NO"],
    "🇵🇱": [" PL", "POL", "波兰","波蘭", "Poland"],
    "🇨🇱": ["智利","Chile","CHILE"],
    ...
    "🇨🇳": ["CN", "China", "shanghai", "回国", "中国","中國", "江苏", "北京", "上海", "广州", "深圳", "杭州", "徐州", "青岛", "宁波", "镇江", "沈阳", "海南", "苏州", "陕西", "四川", "广西", "广东", "国内", "辽宁", "山西", "甘肃", "天津", "江西", "浙江", "武汉", "联通", "电信", "移动", "安徽", "福建", "山东", "成都", "贵州", "河南", "常州", "辽", "西安", "云南", "河北", "昆明", "南京", "内蒙古", "腾讯云", "阿里云"],
    "🇨🇺": ["古巴"],
    "🇸🇲": ["圣马力诺","聖馬利諾"],
    "🇰🇾": ["开曼群岛","開曼群島"],
    "🇫🇯": ["斐济","斐濟"],
